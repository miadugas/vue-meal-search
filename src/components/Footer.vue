<template>
	<div>
		<footer
			class="footer footer-center p-10 bg-base-100 border-gray-200 dark:bg-gray-900 rounded text-gray-400">
			<!-- <div class="grid grid-flow-col gap-4">
				<router-link :to="{ name: 'byName' }" class="link link-hover">About us</router-link>
				<router-link :to="{ name: 'byName' }" class="link link-hover">Contact</router-link>
			</div> -->
			<!-- <div> -->
				<!-- <div class="grid grid-flow-col gap-4">
					<a
			...
			<!-- </div> -->
			<div>
				<p>Copyright © 2023 - All right reserved by MiaCodes</p>
			</div>
		</footer>
	</div>
</template>
